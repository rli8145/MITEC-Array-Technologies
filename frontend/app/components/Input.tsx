      ...
      <div className='flex flex-col'>
        ...
        <form className="max-w-sm  space-y-4">
           ...
           <label htmlFor="visitors" className="text-sm font-medium text-heading">Target CO<sub>2</sub> Emissions</label>
            ...
            <div>
                <label htmlFor="visitors" className="block text-sm font-medium text-heading">CO<sub>2</sub> Cost Tradeoff Ratio</label>
                <input type="text" id="visitors" className="rounded-md bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-4 py-1 shadow-xs placeholder:text-body" placeholder="" required />
            </div>
